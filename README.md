...
the token. A minimal `public` directory is included for compatibility with Vercel projects whose
dashboard configuration requires an Output Directory; application requests still route to the API
function.
